...
import { registerInvoiceImportRoutes } from "./routes/invoice-import";
import { registerInvoiceFileRoutes } from "./routes/invoice-files";
import { registerPartnerRoutes } from "./routes/partners";
import { registerPartnerAdminRoutes } from "./routes/partner-admin";
import { registerPartnerAgreementRoutes } from "./routes/partner-agreement";
...
registerInvoiceImportRoutes(router);
registerInvoiceFileRoutes(router);
registerPartnerRoutes(router);
registerPartnerAdminRoutes(router);
registerPartnerAgreementRoutes(router);
